...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'regionFormat' => '{0} ጊዜ',
      'regionFormat-type-standard' => '{0} መደበኛ ሰዓት',
      'regionFormat-type-daylight' => '{0} የቀን ብርሃን ሰዓት',
      'fallbackFormat' => '{1} ({0}]',
      'zone' => [
        'America' => [
          'Adak' => [
      ...
      'metazone' => [
        ...
        'America_Central' => [
          'long' => [
            'generic' => 'መካከለኛ የሰዓት አቆጣጠር',
            'standard' => 'የመካከላዊ መደበኛ ሰዓት አቆጣጠር',
            'daylight' => 'የመካከላዊ የቀን ሰዓት አቆጣጠር',
          ],
        ],
        'America_Eastern' => [
          'long' => [
            'generic' => 'የምዕራባዊ ሰዓት አቆጣጠር',
            'standard' => 'የምዕራባዊ መደበኛ የሰዓት አቆጣጠር',
            'daylight' => 'የምዕራባዊ የቀን ሰዓት አቆጣጠር',
          ],
        ],
        'America_Mountain' => [
          'long' => [
        ...
        'Arabian' => [
          'long' => [
            'generic' => 'የአረቢያ ሰዓት',
            'standard' => 'የአረቢያ መደበኛ ሰዓት',
            'daylight' => 'የአረቢያ የቀን ብርሃን ሰዓት',
          ],
        ],
        'Argentina' => [
          'long' => [
            'generic' => 'የአርጀንቲና የሰዓት አቆጣጠር',
            'standard' => 'የአርጀንቲና መደበኛ ጊዜ',
        ...
        'Argentina_Western' => [
          'long' => [
            ...
            'daylight' => 'የአርጀንቲና ምስራቃዊ በጋ ሰዓት አቆጣጠር',
          ],
        ],
        'Armenia' => [
          'long' => [
        ...
        'Australia_Eastern' => [
          'long' => [
            'generic' => 'የምዕራባዊ አውስትራሊያ የሰአት አቆጣጠር',
        ...
        'Azerbaijan' => [
          'long' => [
            'generic' => 'የአዘርባይጃን ሰዓት',
            'standard' => 'የአዘርባይጃን መደበኛ ሰዓት',
            'daylight' => 'የአዘርባይጃን ክረምት ሰዓት',
          ],
        ],
        'Azores' => [
          'long' => [
        ...
        'Choibalsan' => [
          'long' => [
            ...
            'daylight' => 'የቾይባልሳን የበጋ የሰአት አቆጣጠር',
          ],
        ],
        'Christmas' => [
          'long' => [
        ...
        'Kazakhstan_Eastern' => [
          'long' => [
            'standard' => 'የምስራቅ ካዛኪስታን ጊዜ',
          ],
        ],
        'Kazakhstan_Western' => [
          'long' => [
            'standard' => 'የምዕራብ ካዛኪስታን ጊዜ',
          ],
        ],
        'Korea' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'ሰሜናዊ ምእራብ የሜክሲኮ ሰዓት አቆጣጠር',
            'standard' => 'ሰሜናዊ ምእራብ የሜክሲኮ መደበኛ ሰዓት አቆጣጠር',
            'daylight' => 'ሰሜናዊ ምእራብ የሜክሲኮ የቀን ሰዓት አቆጣጠር',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
