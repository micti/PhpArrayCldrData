...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'regionFormat-type-standard' => '{0} Standart Vaxtı',
      'regionFormat-type-daylight' => '{0} Yay Vaxtı',
      'fallbackFormat' => '{1} ({0}]',
      'zone' => [
        'America' => [
          'Adak' => [
          ...
          'Winnipeg' => [
            'exemplarCity' => 'Vinipeq',
          ],
          'Yakutat' => [
            'exemplarCity' => 'Yakutat',
          ],
          'Yellowknife' => [
            'exemplarCity' => 'Yelounayf',
          ],
        ],
        'Atlantic' => [
          'Azores' => [
      ...
      'metazone' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'Şimal-Qərbi Meksika Vaxtı',
            'standard' => 'Şimal-Qərbi Meksika Standart Vaxtı',
            'daylight' => 'Şimal-Qərbi Meksika Yay Vaxtı',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
        ...
        'Pierre_Miquelon' => [
          'long' => [
            'generic' => 'San Pier və Mikelon Vaxtı',
            'standard' => 'San Pier və Mikelon Standart Vaxtı',
            'daylight' => 'San Pier və Mikelon Yay Vaxtı',
          ],
        ],
        'Pitcairn' => [
          'long' => [
