  ...
  'dates' => [
    'timeZoneNames' => [
      ...
      'metazone' => [
        ...
        'America_Central' => [
          'long' => [
            'generic' => 'Централно време',
            'standard' => 'Централно стандардно време',
            'daylight' => 'Централно летње рачунање времена',
          ],
        ],
        'America_Eastern' => [
          'long' => [
            ...
            'daylight' => 'Источно летње рачунање времена',
          ],
        ],
        'America_Mountain' => [
          'long' => [
            ...
            'daylight' => 'Планинско летње рачунање времена',
          ],
        ],
        'America_Pacific' => [
          'long' => [
            ...
            'daylight' => 'Пацифичко летње рачунање времена',
          ],
        ],
        'Anadyr' => [
          'long' => [
        ...
        'Hong_Kong' => [
          'long' => [
            ...
            'daylight' => 'Хонгконшко летње рачунање времена',
          ],
        ],
        'Hovd' => [
          'long' => [
        ...
        'Kamchatka' => [
          'long' => [
            ...
            'daylight' => 'Петропавловско-камчатско летње рачунање вемена',
          ],
        ],
        'Kazakhstan_Eastern' => [
          'long' => [
        ...
        'Macau' => [
          'long' => [
            ...
            'daylight' => 'Макао летње рачунање вемена',
          ],
        ],
        'Macquarie' => [
          'long' => [
        ...
        'Magadan' => [
          'long' => [
            ...
            'daylight' => 'Магадан летње рачунање вемена',
          ],
        ],
        'Malaysia' => [
          'long' => [
        ...
        'Pierre_Miquelon' => [
          'long' => [
            ...
            'daylight' => 'Сен Пјер и Микелон летње рачунање вемена',
          ],
        ],
        'Pitcairn' => [
          'long' => [
        ...
        'Taipei' => [
          'long' => [
            ...
            'standard' => 'Таипеи стандардно веме',
