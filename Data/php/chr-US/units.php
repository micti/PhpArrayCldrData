...
return [
  'units' => [
    'long' => [
      ...
      'duration-day' => [
        'displayName' => 'ᏧᏒᎯᏓ',
        'unitPattern-count-one' => '{0} ᏏᎦ',
        'unitPattern-count-other' => '{0} ᏧᏒᎯᏓ',
      ],
      'duration-hour' => [
        'displayName' => 'ᎢᏧᏣᎶᏓ',
        'unitPattern-count-one' => '{0} ᏑᏣᎶᏓ',
        'unitPattern-count-other' => '{0} ᎢᏧᏣᎶᏓ',
        'perUnitPattern' => '{0}/h',
      ],
      ...
      'duration-minute' => [
        'displayName' => 'ᎢᏧᏔᏬᏍᏔᏅ',
        'unitPattern-count-one' => '{0} ᎢᏯᏔᏬᏍᏔᏅ',
        'unitPattern-count-other' => '{0} ᎢᏧᏔᏬᏍᏔᏅ',
      ],
      'duration-month' => [
        'displayName' => 'ᎢᏯᏅᏓ',
        'unitPattern-count-one' => '{0} ᏏᏅᏓ',
        'unitPattern-count-other' => '{0} ᎢᏯᏅᏓ',
      ],
      'duration-nanosecond' => [
        'displayName' => 'ns',
      ...
      'duration-second' => [
        'displayName' => 'ᏗᏎᏢ',
        'unitPattern-count-one' => '{0} ᎠᏎᏢ',
        'unitPattern-count-other' => '{0} ᏗᏎᏢ',
        'perUnitPattern' => '{0}/s',
      ],
      'duration-week' => [
        'displayName' => 'ᎢᏳᎾᏙᏓᏆᏍᏗ',
        'unitPattern-count-one' => '{0} ᏒᎾᏙᏓᏆᏍᏗ',
        'unitPattern-count-other' => '{0} ᎢᏳᎾᏙᏓᏆᏍᏗ',
      ],
      'duration-year' => [
        'displayName' => 'ᏧᏕᏘᏴᏓ',
        'unitPattern-count-one' => '{0} ᏑᏕᏘᏴᏓ',
        'unitPattern-count-other' => '{0} ᏧᏕᏘᏴᏓ',
      ],
      'electric-ampere' => [
        'displayName' => 'amp',
