...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'regionFormat-type-standard' => 'Amser Safonol {0}',
      'regionFormat-type-daylight' => 'Amser Haf {0}',
      'fallbackFormat' => '{1} ({0}]',
      'zone' => [
        'America' => [
          'Adak' => [
          ...
          'Lower_Princes' => [
            'exemplarCity' => 'Lower Prince’s Quarter/Beneden Prinsen Kwartier',
          ],
          'Maceio' => [
            'exemplarCity' => 'Maceió',
          ],
      ...
      'metazone' => [
        ...
        'Azerbaijan' => [
          'long' => [
            'generic' => 'Amser Azerbaijan',
            'standard' => 'Amser Safonol Azerbaijan',
            'daylight' => 'Amser Haf Azerbaijan',
          ],
        ],
        'Azores' => [
          'long' => [
            'generic' => 'Amser Azores',
            'standard' => 'Amser Safonol Azores',
            'daylight' => 'Amser Haf Azores',
          ],
        ],
        'Bangladesh' => [
          'long' => [
        ...
        'Cuba' => [
          'long' => [
            'generic' => 'Amser Cuba',
            'standard' => 'Amser Safonol Cuba',
            'daylight' => 'Amser Haf Cuba',
          ],
        ],
        'Davis' => [
          'long' => [
        ...
        'French_Southern' => [
          'long' => [
            'standard' => 'Amser Deheuol ac Antarctig Frengig',
          ],
        ],
        'GMT' => [
          'long' => [
        ...
        'Kazakhstan_Eastern' => [
          'long' => [
            'standard' => 'Amser Dwyrain Kazakstan',
          ],
        ],
        'Kazakhstan_Western' => [
          'long' => [
            'standard' => 'Amser Gorllewin Kazakstan',
          ],
        ],
        'Korea' => [
          'long' => [
        ...
        'Moscow' => [
          'long' => [
            'generic' => 'Amser Moskfa',
            'standard' => 'Amser Safonol Moskfa',
            'daylight' => 'Amser Haf Moskfa',
          ],
        ],
        'Myanmar' => [
          'long' => [
        ...
        'Taipei' => [
          'long' => [
            'generic' => 'Amser Taibei',
            'standard' => 'Amser Safonol Taibei',
            'daylight' => 'Amser Haf Taibei',
          ],
        ],
        'Tajikistan' => [
          'long' => [
            'standard' => 'Amser Tajikistan',
          ],
        ],
        'Tokelau' => [
          'long' => [
        ...
        'Turkmenistan' => [
          'long' => [
            'generic' => 'Amser Turkmenistan',
            'standard' => 'Amser Safonol Turkmenistan',
            'daylight' => 'Amser Haf Turkmenistan',
          ],
        ],
        'Tuvalu' => [
          'long' => [
