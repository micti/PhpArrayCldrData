    ...
    'timeZoneNames' => [
      ...
      'zone' => [
        ...
        'Europe' => [
          ...
          'Dublin' => [
            'long' => [
              'daylight' => 'Hora de verano irlandesa',
            ],
            'exemplarCity' => 'Dublín',
          ],
          'Gibraltar' => [
      ...
      'metazone' => [
        ...
        'America_Central' => [
          'long' => [
            'generic' => 'Hora del centro de Norteamérica',
            'standard' => 'Hora estándar del centro de Norteamérica',
            'daylight' => 'Hora de verano del centro de Norteamérica',
          ],
        ],
        'America_Eastern' => [
          'long' => [
            'generic' => 'Hora del este de Norteamérica',
            'standard' => 'Hora estándar del este de Norteamérica',
            'daylight' => 'Hora de verano del este de Norteamérica',
          ],
        ],
        'America_Mountain' => [
          'long' => [
            'generic' => 'Hora de la montaña de Norteamérica',
            'standard' => 'Hora estándar de la montaña de Norteamérica',
            'daylight' => 'Hora de verano de la montaña de Norteamérica',
          ],
        ],
        'America_Pacific' => [
          'long' => [
        ...
        'Bangladesh' => [
          'long' => [
            ...
            'daylight' => 'Hora de verano de Bangladesh',
          ],
        ],
        'Bhutan' => [
          'long' => [
        ...
        'Choibalsan' => [
          'long' => [
            'generic' => 'Hora de Choybalsan',
            'standard' => 'Hora estándar de Choybalsan',
            'daylight' => 'Hora de verano de Choybalsan',
          ],
        ],
        'Christmas' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'Hora del noroeste',
            'standard' => 'Hora estándar del noroeste',
            'daylight' => 'Hora de verano del noroeste',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
