...
return [
  'numbers' => [
    'currencies' => [
      ...
      'XAF' => [
        'displayName' => 'فرانک CFA مرکز آفریقا',
        'displayName-count-one' => 'فرانک CFA مرکز آفریقا',
        'displayName-count-other' => 'فرانک CFA مرکز آفریقا',
        'symbol' => 'FCFA',
      ],
      'XAG' => [
        'displayName' => 'نقره',
      ...
      'XOF' => [
        'displayName' => 'فرانک CFA غرب آفریقا',
        'displayName-count-one' => 'فرانک CFA غرب آفریقا',
        'displayName-count-other' => 'فرانک CFA غرب آفریقا',
        'symbol' => 'CFA',
      ],
      'XPD' => [
        'displayName' => 'پالادیم',
      ...
      'XPF' => [
        'displayName' => 'فرانک CFP',
        'displayName-count-one' => 'فرانک CFP',
        'displayName-count-other' => 'فرانک CFP',
        'symbol' => 'CFPF',
      ],
      'XPT' => [
        'displayName' => 'پلاتین',
