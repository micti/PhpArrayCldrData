...
return [
  'units' => [
    'long' => [
      'per' => [
        'compoundUnitPattern' => '{0} بر {1}',
      ],
      'acceleration-g-force' => [
        'displayName' => 'نیروی جاذبه',
        'unitPattern-count-one' => '{0} نیروی جاذبه',
        'unitPattern-count-other' => '{0} جاذبه',
      ],
      'acceleration-meter-per-second-squared' => [
        'displayName' => 'متر بر مجذور ثانیه',
        'unitPattern-count-one' => '{0} متر بر مجذور ثانیه',
        'unitPattern-count-other' => '{0} متر بر مجذور ثانیه',
      ],
      'angle-arc-minute' => [
        'displayName' => 'دقیقهٔ قوسی',
        'unitPattern-count-one' => '{0} دقیقهٔ قوسی',
        'unitPattern-count-other' => '{0} دقیقهٔ قوسی',
      ],
      'angle-arc-second' => [
        'displayName' => 'ثانیهٔ قوسی',
        'unitPattern-count-one' => '{0} ثانیهٔ قوسی',
        'unitPattern-count-other' => '{0} ثانیهٔ قوسی',
      ],
      'angle-degree' => [
        'displayName' => 'درجه',
      ...
      'area-square-centimeter' => [
        ...
        'unitPattern-count-one' => '{0} سانتی‌متر مربع',
        'unitPattern-count-other' => '{0} سانتی‌متر مربع',
      ],
      'area-square-foot' => [
      ...
      'area-square-kilometer' => [
        ...
        'unitPattern-count-one' => '{0} کیلومتر مربع',
        'unitPattern-count-other' => '{0} کیلومتر مربع',
      ],
      'area-square-meter' => [
      ...
      'consumption-liter-per-kilometer' => [
        'displayName' => 'لیتر در کیلومتر',
        'unitPattern-count-one' => '{0} لیتر در کیلومتر',
        'unitPattern-count-other' => '{0} لیتر در کیلومتر',
      ],
      'consumption-mile-per-gallon' => [
        'displayName' => 'مایل در گالن',
      ...
      'energy-kilocalorie' => [
        'displayName' => 'کیلوکالری',
        'unitPattern-count-one' => '{0} کیلوکالری',
        'unitPattern-count-other' => '{0} کیلوکالری',
      ],
      'energy-kilojoule' => [
        'displayName' => 'کیلوژول',
        'unitPattern-count-one' => '{0} کیلوژول',
        'unitPattern-count-other' => '{0} کیلوژول',
      ],
      'energy-kilowatt-hour' => [
        'displayName' => 'کیلووات‌ساعت',
        'unitPattern-count-one' => '{0} کیلووات‌ساعت',
        'unitPattern-count-other' => '{0} کیلووات‌ساعت',
      ],
      'frequency-gigahertz' => [
      ...
      'frequency-kilohertz' => [
        'displayName' => 'کیلوهرتز',
        'unitPattern-count-one' => '{0} کیلوهرتز',
        'unitPattern-count-other' => '{0} کیلوهرتز',
      ],
      'frequency-megahertz' => [
        'displayName' => 'مگاهرتز',
      ...
      'power-kilowatt' => [
        'displayName' => 'کیلووات',
        'unitPattern-count-one' => '{0} کیلووات',
        'unitPattern-count-other' => '{0} کیلووات',
      ],
      'power-megawatt' => [
        'displayName' => 'مگاوات',
      ...
      'pressure-millimeter-of-mercury' => [
        ...
        'unitPattern-count-one' => '{0} میلی‌متر جیوه',
        'unitPattern-count-other' => '{0} میلی‌متر جیوه',
      ],
      'pressure-pound-per-square-inch' => [
        'displayName' => 'پوند در اینچ مربع',
        'unitPattern-count-one' => '{0} پوند در اینچ مربع',
        'unitPattern-count-other' => '{0} پوند در اینچ مربع',
      ],
      'proportion-karat' => [
        'displayName' => 'عیار',
      ...
      'speed-kilometer-per-hour' => [
        ...
        'unitPattern-count-one' => '{0} کیلومتر در ساعت',
        'unitPattern-count-other' => '{0} کیلومتر در ساعت',
      ],
      'speed-meter-per-second' => [
        'displayName' => 'متر در ثانیه',
        'unitPattern-count-one' => '{0} متر در ثانیه',
        'unitPattern-count-other' => '{0} متر در ثانیه',
      ],
      'speed-mile-per-hour' => [
        'displayName' => 'مایل در ساعت',
        'unitPattern-count-one' => '{0} مایل در ساعت',
        'unitPattern-count-other' => '{0} مایل در ساعت',
      ],
      'temperature-celsius' => [
        'displayName' => 'درجهٔ سلسیوس',
        'unitPattern-count-one' => '{0} درجهٔ سلسیوس',
        'unitPattern-count-other' => '{0} درجهٔ سلسیوس',
      ],
      'temperature-fahrenheit' => [
        'displayName' => 'درجهٔ فارنهایت',
        'unitPattern-count-one' => '{0} درجهٔ فارنهایت',
        'unitPattern-count-other' => '{0}°F',
      ],
      'temperature-kelvin' => [
        'displayName' => 'درجهٔ کلوین',
        'unitPattern-count-one' => '{0} درجهٔ کلوین',
        'unitPattern-count-other' => '{0} درجهٔ کلوین',
      ],
      'volume-acre-foot' => [
      ...
      'volume-cubic-centimeter' => [
        ...
        'unitPattern-count-one' => '{0} سانتی‌متر مکعب',
        'unitPattern-count-other' => '{0} سانتی‌متر مکعب',
      ],
      'volume-cubic-foot' => [
      ...
      'volume-cubic-kilometer' => [
        ...
        'unitPattern-count-one' => '{0} کیلومتر مکعب',
        'unitPattern-count-other' => '{0} کیلومتر مکعب',
      ],
      'volume-cubic-meter' => [
      ...
      'volume-fluid-ounce' => [
        ...
        'unitPattern-count-one' => '{0} اونس سیال',
        'unitPattern-count-other' => '{0} اونس سیال',
      ],
      'volume-gallon' => [
        'displayName' => 'گالون',
        'unitPattern-count-one' => '{0} گالون',
        'unitPattern-count-other' => '{0} گالون',
      ],
      'volume-hectoliter' => [
      ...
      'volume-tablespoon' => [
        'displayName' => 'قاشق غذاخوری',
        'unitPattern-count-one' => '{0} قاشق غذاخوری',
        'unitPattern-count-other' => '{0} قاشق غذاخوری',
      ],
      'volume-teaspoon' => [
        'displayName' => 'قاشق چای‌خوری',
        'unitPattern-count-one' => '{0} قاشق چای‌خوری',
        'unitPattern-count-other' => '{0} قاشق چای‌خوری',
      ],
    ],
    'short' => [
      'per' => [
      ...
      'speed-mile-per-hour' => [
        'displayName' => 'مایل در ساعت',
        'unitPattern-count-one' => '{0} m/h',
        'unitPattern-count-other' => '{0} m/h',
      ],
      'temperature-celsius' => [
        'displayName' => 'درجهٔ سلسیوس',
      ...
      'volume-fluid-ounce' => [
        'displayName' => 'اونس سیال',
        'unitPattern-count-one' => '{0}انس‌سیال',
        'unitPattern-count-other' => '{0}انس‌سیال',
      ],
      'volume-gallon' => [
        'displayName' => 'گالون',
        'unitPattern-count-one' => '{0} گالون',
    ...
    'narrow' => [
      ...
      'frequency-gigahertz' => [
        'displayName' => 'گ‌.هرتز',
        'unitPattern-count-one' => '{0} گ.هرتز',
        'unitPattern-count-other' => '{0} گ.هرتز',
      ],
      'frequency-hertz' => [
        'displayName' => 'هرتز',
        'unitPattern-count-one' => '{0} هرتز',
