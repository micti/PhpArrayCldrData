...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'gmtZeroFormat' => 'GMT',
      'regionFormat' => '{0}',
      'regionFormat-type-standard' => 'Bun-àm: {0}',
      'regionFormat-type-daylight' => 'Tìde samhraidh: {0}',
      'fallbackFormat' => '{1} ({0}]',
      'zone' => [
        'America' => [
          'Adak' => [
      ...
      'metazone' => [
        ...
        'Brasilia' => [
          'long' => [
            'generic' => 'Àm Bhrasilia',
            'standard' => 'Bun-àm Bhrasilia',
            'daylight' => 'Tìde samhraidh Bhrasilia',
          ],
        ],
        'Brunei' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'Àm Mheagsago an Iar-thuath',
            'standard' => 'Bun-àm Mheagsago an Iar-thuath',
            'daylight' => 'Tìde samhraidh Mheagsago an Iar-thuath',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
        ...
        'Qyzylorda' => [
          'long' => [
            'generic' => 'Àm Qyzylorda',
            'standard' => 'Bun-àm Qyzylorda',
            'daylight' => 'Tìde samhraidh Qyzylorda',
          ],
        ],
        'Reunion' => [
          'long' => [
