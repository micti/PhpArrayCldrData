  ...
  'units' => [
    'long' => [
      ...
      'acceleration-g-force' => [
        ...
        'unitPattern-count-other' => '{0} forzas G',
      ],
      'acceleration-meter-per-second-squared' => [
        'displayName' => 'metros por segundo cadrado',
        'unitPattern-count-one' => '{0} metro por segundo cadrado',
        'unitPattern-count-other' => '{0} metros por segundo cadrado',
      ],
      'angle-arc-minute' => [
        'displayName' => 'arcominutos',
        'unitPattern-count-one' => '{0} arcominuto',
        'unitPattern-count-other' => '{0} arcominutos',
      ],
      'angle-arc-second' => [
        'displayName' => 'arcosegundos',
        'unitPattern-count-one' => '{0} arcosegundo',
        'unitPattern-count-other' => '{0} arcosegundos',
      ],
      'angle-degree' => [
        'displayName' => 'grados',
      ...
      'angle-radian' => [
        ...
        'unitPattern-count-other' => '{0} radiáns',
      ],
      'area-acre' => [
        'displayName' => 'acres',
      ...
      'area-square-centimeter' => [
        'displayName' => 'centímetros cadrados',
        'unitPattern-count-one' => '{0} centímetro cadrado',
        'unitPattern-count-other' => '{0} centímetros cadrados',
      ],
      'area-square-foot' => [
        'displayName' => 'pés cadrados',
        'unitPattern-count-one' => '{0} pé carado',
        'unitPattern-count-other' => '{0} pés cadrados',
      ],
      'area-square-inch' => [
        'displayName' => 'polgadas cadradas',
        'unitPattern-count-one' => '{0} polgada cadrada',
        'unitPattern-count-other' => '{0} polgadas cadradas',
      ],
      'area-square-kilometer' => [
        'displayName' => 'quilómetros cadrados',
        'unitPattern-count-one' => '{0} quilómetro cadrado',
        'unitPattern-count-other' => '{0} quilómetros cadrados',
      ],
      'area-square-meter' => [
        'displayName' => 'metros cadrados',
        'unitPattern-count-one' => '{0} metro cadrado',
        'unitPattern-count-other' => '{0} metros cadrados',
      ],
      'area-square-mile' => [
        'displayName' => 'millas cadradas',
        'unitPattern-count-one' => '{0} milla cadrada',
        'unitPattern-count-other' => '{0} millas cadradas',
      ],
      'area-square-yard' => [
        'displayName' => 'iardas cadradas',
        'unitPattern-count-one' => '{0} iarda cadrada',
        'unitPattern-count-other' => '{0} iardas cadradas',
      ],
      'consumption-liter-per-kilometer' => [
        'displayName' => 'litros por quilómetro',
        'unitPattern-count-one' => '{0} litro por quilómetro',
        'unitPattern-count-other' => '{0} litros por quilómetro',
      ],
      ...
      'energy-kilocalorie' => [
        'displayName' => 'quilocalorías',
        'unitPattern-count-one' => '{0} quilocaloría',
        'unitPattern-count-other' => '{0} quilocalorías',
      ],
      'energy-kilojoule' => [
      ...
      'length-inch' => [
        'displayName' => 'polgada',
        'unitPattern-count-one' => '{0} polgada',
        'unitPattern-count-other' => '{0} polgadas',
      ],
      'length-kilometer' => [
        'displayName' => 'quilómetros',
      ...
      'length-parsec' => [
        'displayName' => 'pársecs',
        'unitPattern-count-one' => '{0} pársec',
        'unitPattern-count-other' => '{0} pársecs',
      ],
      'length-picometer' => [
      ...
      'length-yard' => [
        ...
        'unitPattern-count-other' => '{0} iardas',
      ],
      'light-lux' => [
        'displayName' => 'lux',
      ...
      'mass-kilogram' => [
        'displayName' => 'quilogramos',
        'unitPattern-count-one' => '{0} quilogramo',
        'unitPattern-count-other' => '{0} quilogramos',
      ],
      'mass-metric-ton' => [
      ...
      'power-horsepower' => [
        'displayName' => 'cabalo de potencia',
        'unitPattern-count-one' => '{0} cabalo de potencia',
        'unitPattern-count-other' => '{0} cabalos de potencia',
      ],
      'power-kilowatt' => [
      ...
      'pressure-hectopascal' => [
        'displayName' => 'hectopascais',
        'unitPattern-count-one' => '{0} hectopascal',
        'unitPattern-count-other' => '{0} hectopascais',
      ],
      'pressure-inch-hg' => [
        'displayName' => 'polgadas de mercurio',
        'unitPattern-count-one' => '{0} polgada de mercurio',
        'unitPattern-count-other' => '{0} polgadas de mercurio',
      ],
      'pressure-millibar' => [
      ...
      'pressure-pound-per-square-inch' => [
        'displayName' => 'libras por polgada cadrada',
        'unitPattern-count-one' => '{0} libra por polgada cadrada',
        'unitPattern-count-other' => '{0} libras por polgada cadrada',
      ],
      'proportion-karat' => [
        'displayName' => 'quilates',
        'unitPattern-count-one' => '{0} quilate',
      ...
      'speed-kilometer-per-hour' => [
        'displayName' => 'quilómetros por hora',
      ...
      'temperature-kelvin' => [
        'displayName' => 'grados Kelvin',
        'unitPattern-count-one' => '{0} grado Kelvin',
        'unitPattern-count-other' => '{0} grados Kelvin',
      ],
      'volume-acre-foot' => [
        'displayName' => 'acres pés',
        'unitPattern-count-one' => '{0} acre pé',
        'unitPattern-count-other' => '{0} acres pés',
      ],
      'volume-bushel' => [
        'displayName' => 'bu',
      ...
      'volume-cubic-foot' => [
        'displayName' => 'pés cúbicos',
        'unitPattern-count-one' => '{0} pé cúbico',
        'unitPattern-count-other' => '{0} pés cúbicos',
      ],
      'volume-cubic-inch' => [
        'displayName' => 'polgadas cúbicas',
        'unitPattern-count-one' => '{0} polgada cúbica',
        'unitPattern-count-other' => '{0} polgadas cúbicas',
      ],
      'volume-cubic-kilometer' => [
        'displayName' => 'quilómetros cúbicos',
      ...
      'volume-cubic-yard' => [
        'displayName' => 'iardas cúbicas',
        'unitPattern-count-one' => '{0} iarda cúbica',
        'unitPattern-count-other' => '{0} iardas cúbicas',
      ],
      'volume-cup' => [
        'displayName' => 'cuncas',
        'unitPattern-count-one' => '{0} cunca',
        'unitPattern-count-other' => '{0} cuncas',
      ],
      'volume-deciliter' => [
      ...
      'volume-gallon' => [
        ...
        'unitPattern-count-other' => '{0} galóns',
      ],
      'volume-hectoliter' => [
      ...
      'volume-tablespoon' => [
        'displayName' => 'culleradas',
        'unitPattern-count-one' => '{0} cullerada',
        'unitPattern-count-other' => '{0} culleradas',
      ],
      'volume-teaspoon' => [
        'displayName' => 'culleriñas',
        'unitPattern-count-one' => '{0} culleriña',
        'unitPattern-count-other' => '{0} culleriñas',
      ],
    ],
    'short' => [
      'per' => [
      ...
      'angle-arc-minute' => [
        'displayName' => 'arcomin',
        'unitPattern-count-one' => '{0} arcomin',
        'unitPattern-count-other' => '{0} arcomin',
      ],
      'angle-arc-second' => [
        'displayName' => 'arcoseg',
        'unitPattern-count-one' => '{0} arcoseg',
        'unitPattern-count-other' => '{0} arcoseg',
      ],
      'angle-degree' => [
        'displayName' => 'º',
      ...
      'duration-millisecond' => [
        'displayName' => 'miliseg',
        'unitPattern-count-one' => '{0} miliseg',
        'unitPattern-count-other' => '{0} miliseg',
      ],
      'duration-minute' => [
        'displayName' => 'min',
      ...
      'energy-kilowatt-hour' => [
        'displayName' => 'kW/h',
        'unitPattern-count-one' => '{0} kW/h',
        'unitPattern-count-other' => '{0} kW/h',
      ],
      'frequency-gigahertz' => [
        'displayName' => 'GHz',
      ...
      'length-centimeter' => [
        'displayName' => 'cent',
        'unitPattern-count-one' => '{0} cent',
        'unitPattern-count-other' => '{0} cent',
      ],
      'length-decimeter' => [
        'displayName' => 'dm',
      ...
      'length-kilometer' => [
        'displayName' => 'quilóm',
        'unitPattern-count-one' => '{0} quilóm',
        'unitPattern-count-other' => '{0} quilóm',
      ],
      'length-light-year' => [
        'displayName' => 'anos luz',
      ...
      'length-meter' => [
        'displayName' => 'met',
        'unitPattern-count-one' => '{0} met',
        'unitPattern-count-other' => '{0} met',
      ],
      'length-micrometer' => [
        'displayName' => 'µm',
      ...
      'length-millimeter' => [
        'displayName' => 'milím',
        'unitPattern-count-one' => '{0} milím',
        'unitPattern-count-other' => '{0} milím',
      ],
      'length-nanometer' => [
        'displayName' => 'nm',
      ...
      'mass-kilogram' => [
        'displayName' => 'quilog',
        'unitPattern-count-one' => '{0} quilog',
        'unitPattern-count-other' => '{0} quilog',
      ],
      'mass-metric-ton' => [
        'displayName' => 'tm',
      ...
      'speed-kilometer-per-hour' => [
        'displayName' => 'km/hora',
        'unitPattern-count-one' => '{0} km por hora',
        'unitPattern-count-other' => '{0} km por hora',
      ],
      'speed-meter-per-second' => [
        'displayName' => 'metros/seg',
        'unitPattern-count-one' => '{0} m/s',
      ...
      'speed-mile-per-hour' => [
        'displayName' => 'millas/hora',
        'unitPattern-count-one' => '{0} mi/h',
        'unitPattern-count-other' => '{0} mi/h',
      ],
      'temperature-celsius' => [
        'displayName' => 'g. Celsius',
        'unitPattern-count-one' => '{0} g Celsius',
        'unitPattern-count-other' => '{0} g Celsius',
      ],
      'temperature-fahrenheit' => [
        'displayName' => '°F',
      ...
      'volume-liter' => [
        'displayName' => 'lit',
        'unitPattern-count-one' => '{0} lit',
        'unitPattern-count-other' => '{0} lit',
      ],
      'volume-megaliter' => [
        'displayName' => 'Ml',
