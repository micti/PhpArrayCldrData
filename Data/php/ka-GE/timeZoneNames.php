...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'gmtZeroFormat' => 'GMT',
      'regionFormat' => 'დრო: {0}',
      'regionFormat-type-standard' => '{0} სტანდარტული დრო',
      'regionFormat-type-daylight' => '{0} ზაფხულის დრო',
      'fallbackFormat' => '{1} ({0}]',
      'zone' => [
        'America' => [
          'Adak' => [
      ...
      'metazone' => [
        ...
        'Alaska' => [
          'long' => [
            'generic' => 'ალასკის დრო',
            'standard' => 'ალასკას სტანდარტული დრო',
            'daylight' => 'ალასკას ზაფხულის დრო',
          ],
        ],
        'Amazon' => [
          'long' => [
        ...
        'Hawaii_Aleutian' => [
          'long' => [
            'generic' => 'ჰავაის და ალეუტის დრო',
            'standard' => 'ჰავაის და ალეუტის სტანდარტული დრო',
            'daylight' => 'ჰავაის და ალეუტის ზაფხულის დრო',
          ],
        ],
        'Hong_Kong' => [
          'long' => [
        ...
        'Macquarie' => [
          'long' => [
            'standard' => 'მაქკუორის კუნძულის დრო',
          ],
        ],
        'Magadan' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'ჩრდილო-აღმოსავლეთ მექსიკის დრო',
            'standard' => 'ჩრდილო-დასავლეთ მექსიკის დრო',
            'daylight' => 'ჩრდილო-დასავლეთ მექსიკის ზაფხულის დრო',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
        ...
        'Norfolk' => [
          'long' => [
            'standard' => 'ნორფოლკის კუნძულის დრო',
          ],
        ],
        'Noronha' => [
          'long' => [
