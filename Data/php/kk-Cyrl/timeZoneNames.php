...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'regionFormat-type-standard' => '{0} стандартты уақыты',
      'regionFormat-type-daylight' => '{0} күндізгі уақыты',
      'fallbackFormat' => '{1} ({0}]',
      'zone' => [
        'America' => [
          'Adak' => [
          ...
          'Kentucky' => [
            'Monticello' => [
              'exemplarCity' => 'Монтиселло, Кентуки',
            ],
          ],
          'Kralendijk' => [
          ...
          'North_Dakota' => [
            'Beulah' => [
              'exemplarCity' => 'Бьюла, Солтүстік Дакота',
            ],
            'Center' => [
              'exemplarCity' => 'Солтүстік Дакота, Орталық',
            ],
            'New_Salem' => [
        ...
        'Atlantic' => [
          ...
          'South_Georgia' => [
            'exemplarCity' => 'Оңтүстік Джорджия',
          ],
          'St_Helena' => [
        ...
        'Europe' => [
          ...
          'Dublin' => [
            'long' => [
              'daylight' => 'Ирландиаялық жазғы уақыт',
            ],
            'exemplarCity' => 'Дублин',
          ],
          'Gibraltar' => [
          ...
          'London' => [
            'long' => [
              'daylight' => 'Ұлыбританиялық жазғы уақыт',
            ],
            'exemplarCity' => 'Лондон',
          ],
          'Luxembourg' => [
        ...
        'Africa' => [
          ...
          'Blantyre' => [
            'exemplarCity' => 'Блантаир',
          ],
          'Brazzaville' => [
            'exemplarCity' => 'Браззавил',
          ],
          'Bujumbura' => [
        ...
        'Indian' => [
          ...
          'Christmas' => [
            'exemplarCity' => 'Кристмас аралдары',
          ],
          'Cocos' => [
      ...
      'metazone' => [
        ...
        'Africa_Southern' => [
          'long' => [
            'standard' => 'Оңтүстік Африка уақыты',
          ],
        ],
        'Africa_Western' => [
          'long' => [
            'generic' => 'Батыс Африка уақыты',
            'standard' => 'Батыс Африка стандарт уақыты',
            'daylight' => 'Батыс Африка жаздық уақыты',
          ],
        ],
        'Alaska' => [
          'long' => [
            ...
            'daylight' => 'Аляска күндізгі уақыты',
          ],
        ],
        'Amazon' => [
          'long' => [
            'generic' => 'Амазон уақыты',
            'standard' => 'Амазон стандартты уақыты',
            'daylight' => 'Амазон жазғы уақыты',
          ],
        ],
        'America_Central' => [
          'long' => [
            'generic' => 'Солтүстік Америка орталығының уақыты',
            'standard' => 'Солтүстік Америка орталығының стандартты уақыты',
            'daylight' => 'Солтүстік Америка орталығының күндізгі уақыты',
          ],
        ],
        'America_Eastern' => [
          'long' => [
            'generic' => 'Оңтүстік Америка шығыс бөлігінің уақыты',
            'standard' => 'Оңтүстік Америка шығыс бөлігінің стандартты уақыты',
            'daylight' => 'Оңтүстік Америка шығыс бөлігінің күндізгі уақыты',
          ],
        ],
        'America_Mountain' => [
          'long' => [
            'generic' => 'Оңтүстік Америка таулы бөлігінің уақыты',
            'standard' => 'Оңтүстік Америка таулы бөлігінің стандартты уақыты',
            'daylight' => 'Оңтүстік Америка таулы бөлігінің күндізгі уақыты',
          ],
        ],
        'America_Pacific' => [
          'long' => [
            'generic' => 'Тынық мұхитындағы Оңтүстік Америка уақыты',
            'standard' => 'Тынық мұхитындағы Оңтүстік Америка стандартты уақыты',
            'daylight' => 'Тынық мұхитындағы Оңтүстік Америка жазғы уақыты',
          ],
        ],
        'Apia' => [
          'long' => [
        ...
        'Arabian' => [
          'long' => [
            ...
            'daylight' => 'Сауд Арабиясы күндізгі уақыты',
          ],
        ],
        'Argentina' => [
          'long' => [
        ...
        'Atlantic' => [
          'long' => [
            ...
            'daylight' => 'Атлантикалық жаздық уақыт',
          ],
        ],
        'Australia_Central' => [
          'long' => [
            'generic' => 'Орталық Австралия уақыты',
            'standard' => 'Австралияның орталық стандарт уақыты',
            'daylight' => 'Австралиялық орталық жаздық уақыт',
          ],
        ],
        'Australia_CentralWestern' => [
          'long' => [
            'generic' => 'Орталық Австралиялық батыс уақыты',
            'standard' => 'Орталық Австралиялық батыс стандарт уақыты',
            'daylight' => 'Орталық Австралиялық батыс жаздық уақыты',
          ],
        ],
        'Australia_Eastern' => [
          'long' => [
            'generic' => 'Шығыс Австралиялық уақыт',
            'standard' => 'Шығыс Австралиялық стандарт уақыты',
            'daylight' => 'Шығыс Австралиялық жаздық уақыт',
          ],
        ],
        'Australia_Western' => [
          'long' => [
            'generic' => 'Батыс Австралиялық уақыт',
            'standard' => 'Батыс Австралиялық стандарт уақыты',
            'daylight' => 'Батыс Австралиялық жаздық уақыт',
          ],
        ],
        'Azerbaijan' => [
          'long' => [
        ...
        'China' => [
          'long' => [
            ...
            'daylight' => 'Қытай күндізгі уақыты',
          ],
        ],
        'Choibalsan' => [
          'long' => [
        ...
        'Christmas' => [
          'long' => [
            'standard' => 'Кристмас аралы уақыты',
          ],
        ],
        'Cocos' => [
          'long' => [
            'standard' => 'Кокос аралдары уақыты',
          ],
        ],
        'Colombia' => [
          'long' => [
        ...
        'Cook' => [
          'long' => [
            'generic' => 'Кук аралдары уақыты',
            'standard' => 'Кук аралдары стандартты уақыты',
            'daylight' => 'Кук аралдары жартылай жазғы уақыты',
          ],
        ],
        'Cuba' => [
          'long' => [
        ...
        'Europe_Central' => [
          'long' => [
            ...
            'standard' => 'Орталық Еуропа стандарт уақыты',
            'daylight' => 'Орталық Еуропа жаздық уақыты',
          ],
        ],
        'Europe_Eastern' => [
          'long' => [
            'generic' => 'Шығыс Еуропа уақыты',
            'standard' => 'Шығыс Еуропа стандарт уақыты',
            'daylight' => 'Шығыс Еуропа жаздық уақыты',
          ],
          'short' => [
            'generic' => 'EET',
            'standard' => 'EET',
        ...
        'Europe_Further_Eastern' => [
          'long' => [
            'standard' => 'Қашық Шығыс Еуропа Уақыты',
          ],
        ],
        'Europe_Western' => [
          'long' => [
            'generic' => 'Батыс Еуропа уақыты',
            'standard' => 'Батыс Еуропа стандарт уақыты',
            'daylight' => 'Батыс Еуропа жаздық уақыты',
          ],
        ],
        'Falkland' => [
          'long' => [
        ...
        'Gilbert_Islands' => [
          'long' => [
            'standard' => 'Гилберт аралдары уақыты',
          ],
        ],
        'Greenland_Eastern' => [
          'long' => [
        ...
        'Gulf' => [
          'long' => [
            'standard' => 'Мексика шығанағы уақыты',
          ],
        ],
        'Guyana' => [
          'long' => [
        ...
        'Israel' => [
          'long' => [
            ...
            'daylight' => 'Израиль күндізгі уақыты',
          ],
        ],
        'Japan' => [
          'long' => [
            ...
            'daylight' => 'Жапония күндізгі уақыты',
          ],
        ],
        'Kazakhstan_Eastern' => [
          'long' => [
        ...
        'Korea' => [
          'long' => [
            ...
            'daylight' => 'Корея күндізгі уақыты',
          ],
        ],
        'Kosrae' => [
          'long' => [
            'standard' => 'Косраэ уақыты',
          ],
        ],
        'Krasnoyarsk' => [
          'long' => [
        ...
        'Macquarie' => [
          'long' => [
            'standard' => 'Маккуори аралы уақыты',
          ],
        ],
        'Magadan' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'Солтүстік Мексика Уақыты',
            'standard' => 'Солтүстік Мексика Стандартты Уақыты',
            'daylight' => 'Солтүстік Мексика Күндізгі Уақыты',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
            'generic' => 'Мексика Тынық Мұхит Уақыты',
            'standard' => 'Мексика Тынық Мұхит Стандартты Уақыты',
            'daylight' => 'Мексика Тынық Мұхит Күндізгі Уақыты',
          ],
        ],
        'Mongolia' => [
          'long' => [
            'generic' => 'Улан-Батор уақыты',
            'standard' => 'Улан-Батор стандартты уақыты',
            'daylight' => 'Улан-Батор жазғы уақыты',
          ],
        ],
        'Moscow' => [
          'long' => [
        ...
        'New_Zealand' => [
          'long' => [
            ...
            'daylight' => 'Жаңа Зеландия күндізгі уақыты',
          ],
        ],
        'Newfoundland' => [
          'long' => [
        ...
        'Philippines' => [
          'long' => [
            'generic' => 'Филиппин уақыты',
            'standard' => 'Филиппин стандартты уақыты',
            'daylight' => 'Филиппин жазғы уақыты',
          ],
        ],
        'Phoenix_Islands' => [
          'long' => [
        ...
        'Pierre_Miquelon' => [
          'long' => [
            ...
            'daylight' => 'Сен-Пьер және Микелон күндізгі уақыты',
          ],
        ],
        'Pitcairn' => [
          'long' => [
        ...
        'Samoa' => [
          'long' => [
            ...
            'daylight' => 'Самоа күндізгі уақыты',
          ],
        ],
        'Seychelles' => [
          'long' => [
            'standard' => 'Сейшель уақыты',
          ],
        ],
        'Singapore' => [
          'long' => [
            'standard' => 'Сингапур уақыты',
          ],
        ],
        'Solomon' => [
          'long' => [
        ...
        'Taipei' => [
          'long' => [
            ...
            'daylight' => 'Тайбэй күндізгі уақыты',
          ],
        ],
        'Tajikistan' => [
          'long' => [
