...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'gmtZeroFormat' => 'GMT',
      'regionFormat' => '{0} ಸಮಯ',
      'regionFormat-type-standard' => '{0} (+0] ಪ್ರಮಾಣಿತ ಸಮಯ',
      'regionFormat-type-daylight' => '{0} (+1] ದಿನದ ಸಮಯ',
      'fallbackFormat' => '{1} ({0}]',
      'zone' => [
        'America' => [
          'Adak' => [
          ...
          'Winnipeg' => [
            'exemplarCity' => 'ವಿನ್ನಿಪೇಗ್',
          ],
          'Yakutat' => [
            'exemplarCity' => 'ಯಾಕುಟಾಟ್',
          ],
          'Yellowknife' => [
            'exemplarCity' => 'ಯೆಲ್ಲೋ‌ನೈಫ್',
          ],
        ],
        'Atlantic' => [
          'Azores' => [
        ...
        'Asia' => [
          ...
          'Kamchatka' => [
            'exemplarCity' => 'ಕಮ್ಚತ್ಕ',
          ],
          'Karachi' => [
            'exemplarCity' => 'ಕರಾಚಿ',
          ],
          'Kashgar' => [
            'exemplarCity' => 'ಕಶ್‌ಗರ್',
          ],
          'Katmandu' => [
      ...
      'metazone' => [
        ...
        'Falkland' => [
          'long' => [
            'generic' => 'ಫಾಲ್ಕ್‌ಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳ ಸಮಯ',
            'standard' => 'ಫಾಲ್ಕ್‌ಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳ ಪ್ರಮಾಣಿತ ಸಮಯ',
            'daylight' => 'ಫಾಲ್ಕ್‌ಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳ ಬೇಸಿಗೆ ಸಮಯ',
          ],
        ],
        'Fiji' => [
          'long' => [
        ...
        'Hovd' => [
          'long' => [
            'generic' => 'ಹವ್ಡ್ ಸಮಯ',
            'standard' => 'ಹವ್ಡ್ ಸ್ಟ್ಯಾಂಡರ್ಡ್ ಸಮಯ',
        ...
        'Indonesia_Central' => [
          'long' => [
            'standard' => 'ಮಧ್ಯ ಇಂಡೋನೇಷಿಯ ಸಮಯ',
          ],
        ],
        'Indonesia_Eastern' => [
          'long' => [
            'standard' => 'ಪೂರ್ವ ಇಂಡೋನೇಷಿಯ ಸಮಯ',
          ],
        ],
        'Indonesia_Western' => [
          'long' => [
        ...
        'Macquarie' => [
          'long' => [
            'standard' => 'ಮ್ಯಾಕ್‌ಕ್ಯುರೈ ದ್ವೀಪ ಸಮಯ',
          ],
        ],
        'Magadan' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'ವಾಯವ್ಯ ಮೆಕ್ಸಿಕೊ ಸಮಯ',
            'standard' => 'ವಾಯವ್ಯ ಮೆಕ್ಸಿಕೊ ಪ್ರಮಾಣಿತ ಸಮಯ',
            'daylight' => 'ವಾಯವ್ಯ ಮೆಕ್ಸಿಕೊ ಹಗಲು ಸಮಯ',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
        ...
        'Mongolia' => [
          'long' => [
            'generic' => 'ಉಲನ್ ಬ್ಯಾಟರ್ ಸಮಯ',
            'standard' => 'ಉಲನ್ ಬ್ಯಾಟರ್ ಪ್ರಮಾಣಿತ ಸಮಯ',
            'daylight' => 'ಉಲನ್ ಬ್ಯಾಟರ್ ಬೇಸಿಗೆ ಸಮಯ',
          ],
        ],
        'Moscow' => [
          'long' => [
        ...
        'Novosibirsk' => [
          'long' => [
            ...
            'standard' => 'ನೊವೊಸಿಬಿಸ್ಕ್ ಪ್ರಮಾಣಿತ ಸಮಯ',
