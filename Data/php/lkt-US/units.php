...
return [
  'units' => [
    'long' => [
      ...
      'duration-day' => [
        'displayName' => '-čháŋ',
        'unitPattern-count-other' => '{0}-čháŋ',
      ],
      'duration-hour' => [
        'displayName' => 'Owápȟe',
        'unitPattern-count-other' => 'Owápȟe {0}',
        'perUnitPattern' => '{0}/h',
      ],
      ...
      'duration-month' => [
        'displayName' => 'Wíyawapi',
        'unitPattern-count-other' => 'Wíyawapi {0}',
      ],
      'duration-nanosecond' => [
        'displayName' => 'ns',
      ...
      'duration-second' => [
        'displayName' => 'Okpí',
        'unitPattern-count-other' => 'Okpí {0}',
        'perUnitPattern' => '{0}/s',
      ],
      'duration-week' => [
        'displayName' => 'okó',
        'unitPattern-count-other' => 'okó {0}',
      ],
      'duration-year' => [
        'displayName' => 'ómakȟa',
        'unitPattern-count-other' => 'ómakȟa {0}',
      ],
      'electric-ampere' => [
        'displayName' => 'amp',
      ...
      'length-foot' => [
        'displayName' => 'siíyutȟapi',
        'unitPattern-count-other' => 'siíyutȟapi {0}',
      ],
      'length-furlong' => [
        'displayName' => 'fur',
      ...
      'length-inch' => [
        'displayName' => 'oíyutȟe čísčila',
        'unitPattern-count-other' => 'oíyutȟe čísčila {0}',
      ],
      'length-kilometer' => [
        'displayName' => 'km',
        'unitPattern-count-other' => '{0} km',
      ...
      'length-mile' => [
        'displayName' => 'makhíyutȟapi',
        'unitPattern-count-other' => 'makhíyutȟapi {0}',
      ],
      'length-millimeter' => [
        'displayName' => 'mm',
      ...
      'length-yard' => [
        'displayName' => 'čhaéglepi',
        'unitPattern-count-other' => 'čhaéglepi {0}',
      ],
      'light-lux' => [
        'displayName' => 'lx',
      ...
      'mass-pound' => [
        'displayName' => 'tkeíyutȟapi',
        'unitPattern-count-other' => 'tkeíyutȟapi {0}',
      ],
      'mass-stone' => [
        'displayName' => 'st',
    ...
    'narrow' => [
      ...
      'length-mile' => [
        'displayName' => 'makhíyutȟapi',
        'unitPattern-count-other' => '{0} makh',
      ],
      'length-millimeter' => [
        'displayName' => 'mm',
        'unitPattern-count-other' => '{0} mm',
