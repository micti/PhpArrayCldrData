  ...
  'numbers' => [
    'currencies' => [
      ...
      'CHF' => [
        ...
        'displayName-count-other' => 'സ്വിസ് ഫ്രാങ്ക്സ്',
        'symbol' => 'CHF',
      ],
      'CHW' => [
      ...
      'GBP' => [
        'displayName' => 'ബ്രിട്ടീഷ് പൗണ്ട് സ്‌റ്റെർലിംഗ്',
        'displayName-count-one' => 'ബ്രിട്ടീഷ് പൗണ്ട് സ്‌റ്റെർലിംഗ്',
        'displayName-count-other' => 'ബ്രിട്ടീഷ് പൗണ്ട് സ്‌റ്റെർലിംഗ്',
        'symbol' => '£',
        'symbol-alt-narrow' => '£',
      ],
      'GEK' => [
      ...
      'GEL' => [
        ...
        'displayName-count-other' => 'ജോർജ്ജിയൻ ലാറി',
        'symbol' => 'GEL',
      ],
      'GHC' => [
      ...
      'KZT' => [
        'displayName' => 'കസാക്കിസ്ഥാൻ ടെംഗെ',
        'displayName-count-one' => 'കസാക്കിസ്ഥാൻ ടെംഗെ',
        'displayName-count-other' => 'കസാക്കിസ്ഥാൻ ടെംഗെ',
        'symbol' => 'KZT',
        'symbol-alt-narrow' => '₸',
      ],
      'LAK' => [
      ...
      'PEN' => [
        'displayName' => 'പെറുവിയൻ ന്യൂവോ സോൾ',
        'displayName-count-one' => 'പെറുവിയൻ ന്യൂവോ സോൾ',
        'displayName-count-other' => 'പെറുവിയൻ ന്യൂവോ സോൾ',
        'symbol' => 'PEN',
      ],
      'PES' => [
        'displayName' => 'പെറൂവിയൻ സോൾ',
        'displayName-count-one' => 'പെറൂവിയൻ സോൾ',
        'displayName-count-other' => 'പെറൂവിയൻ സോൾസ്',
        'symbol' => 'PES',
      ],
      'PGK' => [
      ...
      'TJS' => [
        'displayName' => 'താജിക്കിസ്ഥാനി സൊമോനി',
        'displayName-count-one' => 'താജിക്കിസ്ഥാനി സൊമോനി',
      ...
      'UZS' => [
        'displayName' => 'ഉസ്‌ബെക്കിസ്ഥാൻ സോം',
        'displayName-count-one' => 'ഉസ്‌ബെക്കിസ്ഥാൻ സോം',
        'displayName-count-other' => 'ഉസ്‌ബെക്കിസ്ഥാൻ സോം',
        'symbol' => 'UZS',
      ],
      'VEB' => [
      ...
      'XAF' => [
        'displayName' => 'CFA ഫ്രാങ്ക് BEAC',
        'displayName-count-one' => 'CFA ഫ്രാങ്ക് BEAC',
        'displayName-count-other' => 'CFA ഫ്രാങ്ക് BEAC',
        'symbol' => 'FCFA',
      ],
      'XAG' => [
        'displayName' => 'വെള്ളി',
      ...
      'XOF' => [
        'displayName' => 'CFA ഫ്രാങ്ക് BCEAO',
        'displayName-count-one' => 'CFA ഫ്രാങ്ക് BCEAO',
        'displayName-count-other' => 'CFA ഫ്രാങ്ക് BCEAO',
        'symbol' => 'CFA',
      ],
      'XPD' => [
        'displayName' => 'പലാഡിയം',
      ...
      'XPF' => [
        ...
        'displayName-count-other' => 'CFP ഫ്രാങ്ക്സ്',
        'symbol' => 'CFPF',
      ],
      'XPT' => [
