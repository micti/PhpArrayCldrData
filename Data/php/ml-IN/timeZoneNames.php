...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'regionFormat' => '{0} സമയം',
      'regionFormat-type-standard' => '{0} സ്റ്റാന്റേഡ് സമയം',
      ...
      'zone' => [
        'America' => [
          ...
          'Kentucky' => [
            'Monticello' => [
              'exemplarCity' => 'മോണ്ടിസെല്ലോ, കെൻറക്കി',
            ],
          ],
          'Kralendijk' => [
          ...
          'Santa_Isabel' => [
            'exemplarCity' => 'സാന്ത ഇസബേൽ',
          ],
          'Santarem' => [
            'exemplarCity' => 'സാൻററെം',
          ],
          'Santiago' => [
            'exemplarCity' => 'സാൻറിയാഗോ',
          ],
          'Santo_Domingo' => [
          ...
          'St_Lucia' => [
            'exemplarCity' => 'സെൻറ് ലൂസിയ',
          ],
          'St_Thomas' => [
            'exemplarCity' => 'സെൻറ്. തോമസ്',
          ],
          'St_Vincent' => [
            'exemplarCity' => 'സെൻറ് വിൻ‌സെൻറ്',
          ],
          'Swift_Current' => [
            'exemplarCity' => 'സ്വിഫ്റ്റ് കറൻറ്',
          ],
          'Tegucigalpa' => [
        ...
        'Africa' => [
          ...
          'Nouakchott' => [
            'exemplarCity' => 'നൌവാൿഷോട്ട്',
          ],
          'Ouagadougou' => [
            'exemplarCity' => 'ഔഗാദൌഗൌ',
          ],
          'Porto-Novo' => [
        ...
        'Asia' => [
          ...
          'Phnom_Penh' => [
            'exemplarCity' => 'നാം പെൻ',
          ],
          'Pontianak' => [
            'exemplarCity' => 'പൊൻറിയാനക്',
          ],
          'Pyongyang' => [
        ...
        'Indian' => [
          ...
          'Maldives' => [
            'exemplarCity' => 'മാലിദ്വീപുകൾ',
          ],
          'Mauritius' => [
            'exemplarCity' => 'മൌറീഷ്യസ്',
          ],
          'Mayotte' => [
        ...
        'Pacific' => [
          ...
          'Gambier' => [
            'exemplarCity' => 'ഗാന്പിയർ',
          ],
          'Guadalcanal' => [
            'exemplarCity' => 'ഗ്വാഡോ കനാൽ',
          ],
          'Guam' => [
            'exemplarCity' => 'ഗ്വാം',
          ],
      ...
      'metazone' => [
        ...
        'America_Central' => [
          'long' => [
            ...
            'daylight' => 'വടക്കെ അമേരിക്കൻ സെൻട്രൽ പകൽ സമയം',
          ],
        ],
        'America_Eastern' => [
          'long' => [
        ...
        'America_Mountain' => [
          'long' => [
            ...
            'daylight' => 'വടക്കെ അമേരിക്കൻ മൌണ്ടൻ പകൽ സമയം',
          ],
        ],
        'America_Pacific' => [
          'long' => [
            ...
            'daylight' => 'വടക്കെ അമേരിക്കൻ പസഫിക് പകൽ സമയം',
          ],
        ],
        'Anadyr' => [
          'long' => [
        ...
        'Atlantic' => [
          'long' => [
            'generic' => 'അറ്റ്ലാൻറിക് സമയം',
            'standard' => 'അറ്റ്ലാൻറിക് സ്റ്റാൻഡേർഡ് സമയം',
            'daylight' => 'അറ്റ്ലാൻറിക് പകൽ സമയം',
          ],
        ],
        'Australia_Central' => [
          'long' => [
            ...
            'daylight' => 'ഓസ്ട്രേലിയൻ സെൻട്രൽ പകൽ സമയം',
          ],
        ],
        ...
        'Europe_Central' => [
          'long' => [
            ...
            'daylight' => 'സെൻട്രൽ യൂറോപ്യൻ വേനൽക്കാല സമയം',
          ],
        ],
        'Europe_Eastern' => [
          'long' => [
            ...
            'daylight' => 'കിഴക്കൻ യൂറോപ്യൻ വേനൽക്കാല സമയം',
          ],
        ],
        'Europe_Further_Eastern' => [
          'long' => [
            'standard' => 'ഇനിയും-കിഴക്കൻ യൂറോപ്യൻ സമയം',
          ],
        ],
        'Europe_Western' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'വടക്കുപടിഞ്ഞാറൻ മെക്സിക്കൻ സമയം',
            'standard' => 'വടക്കുപടിഞ്ഞാറൻ മെക്‌സിക്കൻ സ്റ്റാൻഡേർഡ് സമയം',
            'daylight' => 'വടക്കുപടിഞ്ഞാറൻ മെക്സിക്കൻ ഡേലൈറ്റ് സമയം',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
            'generic' => 'മെക്സിക്കൻ പസഫിക് സമയം',
            'standard' => 'മെക്സിക്കൻ പസഫിക് സാധാരണ സമയം',
            'daylight' => 'മെക്സിക്കൻ പസഫിക് ഡേലൈറ്റ് സമയം',
          ],
        ],
        'Mongolia' => [
          'long' => [
            'generic' => 'ഉലൻ ബറ്റർ സമയം',
            'standard' => 'ഉലൻ ബറ്റർ സ്റ്റാൻഡേർഡ് സമയം',
            'daylight' => 'ഉലൻ ബറ്റർ ഗ്രീഷ്‌മകാല സമയം',
          ],
        ],
        'Moscow' => [
          'long' => [
        ...
        'Newfoundland' => [
          'long' => [
            'generic' => 'ന്യൂഫൗണ്ട്ലാൻഡ് സമയം',
            'standard' => 'ന്യൂഫൗണ്ട്ലാൻഡ് സ്റ്റാൻഡേർഡ് സമയം',
            'daylight' => 'ന്യൂഫൗണ്ട്ലാൻഡ് ഡേലൈറ്റ് സമയം',
          ],
        ],
        'Niue' => [
          'long' => [
        ...
        'Norfolk' => [
          'long' => [
            'standard' => 'നോർഫാക്ക് ദ്വീപുകൾ സമയം',
          ],
        ],
        'Noronha' => [
          'long' => [
        ...
        'Phoenix_Islands' => [
          'long' => [
            'standard' => 'ഫിനിക്‌സ് ദ്വീപുകൾ സമയം',
          ],
        ],
        'Pierre_Miquelon' => [
          'long' => [
