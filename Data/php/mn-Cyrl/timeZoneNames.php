    ...
    'timeZoneNames' => [
      ...
      'zone' => [
        'America' => [
          ...
          'Glace_Bay' => [
            'exemplarCity' => 'Глейс бэй',
          ],
          'Godthab' => [
            'exemplarCity' => 'Нүүк',
          ],
          'Goose_Bay' => [
            'exemplarCity' => 'Гуус бэй',
          ],
          'Grand_Turk' => [
        ...
        'Australia' => [
          'Adelaide' => [
            'exemplarCity' => 'Аделэйд',
          ],
          'Brisbane' => [
            'exemplarCity' => 'Брисбэн',
          ],
          'Broken_Hill' => [
      ...
      'metazone' => [
        ...
        'Brunei' => [
          'long' => [
            'standard' => 'Бруней Дарассаламын цаг',
          ],
        ],
        'Cape_Verde' => [
          'long' => [
            'generic' => 'Кэйп Вердийн цаг',
            'standard' => 'Кэйп Вердийн стандарт цаг',
            'daylight' => 'Кэйп Вердийн зуны цаг',
          ],
        ],
        'Chamorro' => [
          'long' => [
        ...
        'Chatham' => [
          'long' => [
            'generic' => 'Чэтамын цаг',
            'standard' => 'Чэтамын стандарт цаг',
            'daylight' => 'Чэтамын зуны цаг',
          ],
        ],
        'Chile' => [
          'long' => [
        ...
        'Cook' => [
          'long' => [
            'generic' => 'Күүк арлын цаг',
            'standard' => 'Күүк арлын стандарт цаг',
            'daylight' => 'Күүк арлын хагас зуны цаг',
          ],
        ],
        'Cuba' => [
          'long' => [
        ...
        'Easter' => [
          'long' => [
            'generic' => 'Истерын Арлын цаг',
            'standard' => 'Истерын Арлын стандарт цаг',
            'daylight' => 'Истерын Арлын зуны цаг',
          ],
        ],
        'Ecuador' => [
          'long' => [
        ...
        'Falkland' => [
          'long' => [
            'generic' => 'Фолькландын Арлуудын цаг',
            'standard' => 'Фолькландын Арлуудын стандарт цаг',
            'daylight' => 'Фолькландын Арлуудын зуны цаг',
          ],
        ],
        'Fiji' => [
          'long' => [
        ...
        'French_Guiana' => [
          'long' => [
            'standard' => 'Францын Гияанагийн цаг',
          ],
        ],
        'French_Southern' => [
          'long' => [
            'standard' => 'Францын Өмнөд ба Антарктик цаг',
          ],
        ],
        'GMT' => [
          'long' => [
            'standard' => 'Гринвичийн үндсэн цаг',
          ],
        ],
        'Galapagos' => [
          'long' => [
        ...
        'Gilbert_Islands' => [
          'long' => [
            'standard' => 'Жильбер арлын цаг',
          ],
        ],
        'Greenland_Eastern' => [
          'long' => [
            'generic' => 'Зүүн Гринландын цаг',
            'standard' => 'Зүүн Гринландын стандарт цаг',
            'daylight' => 'Зүүн Гринландын зуны цаг',
          ],
        ],
        'Greenland_Western' => [
          'long' => [
            'generic' => 'Баруун Гринландын цаг',
            'standard' => 'Баруун Гринландын стандарт цаг',
            'daylight' => 'Баруун Гринландын зуны цаг',
          ],
        ],
        'Gulf' => [
          'long' => [
            'standard' => 'Гольфийн стандарт цаг',
          ],
        ],
        'Guyana' => [
          'long' => [
            'standard' => 'Гуяанагийн цаг',
          ],
        ],
        'Hawaii_Aleutian' => [
          'long' => [
        ...
        'Hong_Kong' => [
          'long' => [
            'generic' => 'Хонг Конгын цаг',
            'standard' => 'Хонг Конгын стандарт цаг',
            'daylight' => 'Хонг Конгын зуны цаг',
          ],
        ],
        'Hovd' => [
          'long' => [
        ...
        'Kyrgystan' => [
          'long' => [
            'standard' => 'Кыргызстаны цаг',
          ],
        ],
        'Line_Islands' => [
          'long' => [
            'standard' => 'Лайн арлын цаг',
          ],
        ],
        'Lord_Howe' => [
          'long' => [
            'generic' => 'Лорд Хаугийн цаг',
            'standard' => 'Лорд Хаугийн стандарт цаг',
            'daylight' => 'Лорд Хаугийн зуны цаг',
          ],
        ],
        'Macquarie' => [
          'long' => [
            'standard' => 'Маккуори Арлын цаг',
          ],
        ],
        'Magadan' => [
          'long' => [
        ...
        'Marquesas' => [
          'long' => [
            'standard' => 'Маркесасын цаг',
          ],
        ],
        'Marshall_Islands' => [
          'long' => [
            'standard' => 'Маршаллын арлын цаг',
          ],
        ],
        'Mauritius' => [
          'long' => [
            'generic' => 'Мавритусын цаг',
            'standard' => 'Мавритусын стандарт цаг',
            'daylight' => 'Мавритусын зуны цаг',
          ],
        ],
        'Mawson' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'Баруун хойд Мексикийн цаг',
            'standard' => 'Баруун хойд Мексикийн стандарт цаг',
            'daylight' => 'Баруун хойд Мексикийн зуны цаг',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
            'generic' => 'Мексикийн номхон далайн цаг',
            'standard' => 'Мексикийн номхон далайн стандарт цаг',
            'daylight' => 'Мексикийн номхон далайн зуны цаг',
          ],
        ],
        'Mongolia' => [
          'long' => [
        ...
        'Philippines' => [
          'long' => [
            'generic' => 'Филиппины цаг',
            'standard' => 'Филиппины стандарт цаг',
            'daylight' => 'Филиппины зуны цаг',
          ],
        ],
        'Phoenix_Islands' => [
          'long' => [
        ...
        'Pierre_Miquelon' => [
          'long' => [
            'generic' => 'Сент-Пьерре ба Микелоны цаг',
            'standard' => 'Сент-Пьерре ба Микелоны стандарт цаг',
            'daylight' => 'Сент-Пьерре ба Микелоны зуны цаг',
          ],
        ],
        'Pitcairn' => [
          'long' => [
