...
return [
  'numbers' => [
    'currencies' => [
      ...
      'GBP' => [
        'displayName' => 'ਬ੍ਰਿਟਿਸ਼ ਪੌਂਡ ਸਟਰਲਿੰਗ',
        'displayName-count-one' => 'ਬ੍ਰਿਟਿਸ਼ ਪੌਂਡ ਸਟਰਲਿੰਗ',
        'displayName-count-other' => 'ਬ੍ਰਿਟਿਸ਼ ਪੌਂਡ ਸਟਰਲਿੰਗ',
        'symbol' => '£',
        'symbol-alt-narrow' => '£',
      ],
      'GEK' => [
      ...
      'PEN' => [
        'displayName' => 'ਪੇਰੂਵੀਅਨ ਨਿਊਵੋ ਸੋਲ',
        'displayName-count-one' => 'ਪੇਰੂਵੀਅਨ ਨਿਊਵੋ ਸੋਲ',
        'displayName-count-other' => 'ਪੇਰੂਵੀਅਨ ਨਿਊਵੋ ਸੋਲ',
        'symbol' => 'PEN',
      ],
      'PES' => [
        'displayName' => 'PES',
      ...
      'XAF' => [
        'displayName' => 'ਫ੍ਰੈਂਕ (CFA BEAC]',
        'displayName-count-one' => 'ਫ੍ਰੈਂਕ (CFA BEAC]',
        'displayName-count-other' => 'ਫ੍ਰੈਂਕ (CFA BEAC]',
        'symbol' => 'FCFA',
      ],
      'XAG' => [
        'displayName' => 'ਚਾਂਦੀ',
      ...
      'XOF' => [
        'displayName' => 'ਫ੍ਰੈਂਕ (CFA BCEAO]',
        'displayName-count-one' => 'ਫ੍ਰੈਂਕ (CFA BCEAO]',
        'displayName-count-other' => 'ਫ੍ਰੈਂਕ (CFA BCEAO]',
        'symbol' => 'CFA',
      ],
      'XPD' => [
        'displayName' => 'XPD',
