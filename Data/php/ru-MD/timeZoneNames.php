    ...
    'timeZoneNames' => [
      ...
      'zone' => [
        ...
        'Atlantic' => [
          ...
          'South_Georgia' => [
            'exemplarCity' => 'Юж. Георгия и Юж. Сэндвинчевы о-ва',
          ],
          'St_Helena' => [
      ...
      'metazone' => [
        ...
        'Apia' => [
          'long' => [
            'generic' => 'время Апиа, Самоа',
            'standard' => 'Стандартное время Апиа, Самоа',
            'daylight' => 'летнее время Апиа, Самоа',
          ],
        ],
        'Aqtau' => [
          'long' => [
        ...
        'Cook' => [
          'long' => [
            'generic' => 'Кука, о-ва',
            'standard' => 'Кука, о-ва, стандартное время',
            'daylight' => 'Кука, о-ва, полулетнее время',
          ],
        ],
        'Cuba' => [
          'long' => [
        ...
        'Europe_Further_Eastern' => [
          'long' => [
            'standard' => 'время в Калининграде и Минске',
          ],
        ],
        'Europe_Western' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'Североамериканское мексиканское время',
            'standard' => 'Североамериканское мексиканское стандартное время',
            'daylight' => 'Североамериканское мексиканское летнее время',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
