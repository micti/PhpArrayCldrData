...
return [
  'dates' => [
    'timeZoneNames' => [
      ...
      'regionFormat-type-standard' => '{0} සම්මත වේලාව',
      'regionFormat-type-daylight' => '{0} දිවාආලෝක වේලාව',
      'fallbackFormat' => '{1} ({0}]',
      'zone' => [
        'America' => [
          'Adak' => [
        ...
        'Europe' => [
          ...
          'Dublin' => [
            'long' => [
              'daylight' => 'අයර්ලන්ත ගිම්හාන කාලය',
            ],
          ...
          'London' => [
            'long' => [
              'daylight' => 'බ්‍රිතාන්‍ය ගිම්හාන කාලය',
            ],
            'exemplarCity' => 'ලන්ඩන්',
          ],
          'Luxembourg' => [
      ...
      'metazone' => [
        ...
        'Macquarie' => [
          'long' => [
            'standard' => 'මැක්කුඅරි දුපත් වේලාව',
          ],
        ],
        'Magadan' => [
          'long' => [
        ...
        'Mexico_Northwest' => [
          'long' => [
            'generic' => 'වයඹ මෙක්සිකෝ වේලාව',
            'standard' => 'වයඹ මෙක්සිකෝ සම්මත වේලාව',
            'daylight' => 'වයඹ මෙක්සිකෝ දිවාආලෝක වේලාව',
          ],
        ],
        'Mexico_Pacific' => [
          'long' => [
