    ...
    'timeZoneNames' => [
      ...
      'zone' => [
        'America' => [
          ...
          'Kentucky' => [
            'Monticello' => [
              'exemplarCity' => 'Монтічелло, Кентуккі',
            ],
          ],
          'Kralendijk' => [
          ...
          'North_Dakota' => [
            ...
            'Center' => [
              'exemplarCity' => 'Центр, Північна Дакота',
            ],
            'New_Salem' => [
        ...
        'Indian' => [
          ...
          'Comoro' => [
            'exemplarCity' => 'Коморські острови',
          ],
          'Kerguelen' => [
        ...
        'Pacific' => [
          ...
          'Galapagos' => [
            'exemplarCity' => 'Галапагоські острови',
          ],
          'Gambier' => [
            'exemplarCity' => 'Гамбер',
          ],
      ...
      'metazone' => [
        ...
        'Choibalsan' => [
          'long' => [
            'generic' => 'за часом у Чойбалсан',
            'standard' => 'за стандартним часом у Чойбалсан',
            'daylight' => 'за літнім часом у Чойбалсан',
          ],
        ],
        'Christmas' => [
          'long' => [
        ...
        'DumontDUrville' => [
          'long' => [
            'standard' => 'за часом у Дюмон д’Юрвіль',
          ],
        ],
        'East_Timor' => [
          'long' => [
        ...
        'French_Guiana' => [
          'long' => [
            'standard' => 'за часом Французької Гвіани',
          ],
        ],
        'French_Southern' => [
          'long' => [
        ...
        'Newfoundland' => [
          'long' => [
            'generic' => 'за часом у Ньюфаундленд',
            'standard' => 'за стандартним часом у Ньюфаундленд',
        ...
        'Paraguay' => [
          'long' => [
            'generic' => 'за парагвайським часом',
            'standard' => 'за стандартним парагвайським часом',
            'daylight' => 'за літнім парагвайським часом',
          ],
        ],
        'Peru' => [
          'long' => [
        ...
        'Uruguay' => [
          'long' => [
            'generic' => 'за часом в Уругваї',
            'standard' => 'за стандартним часом в Уругваї',
            'daylight' => 'за літнім часом в Уругваї',
          ],
        ],
        'Uzbekistan' => [
          'long' => [
