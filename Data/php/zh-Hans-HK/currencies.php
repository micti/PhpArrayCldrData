...
return [
  'numbers' => [
    'currencies' => [
      ...
      'HNL' => [
        'displayName' => '洪都拉斯拉伦皮拉',
        'displayName-count-other' => '洪都拉斯拉伦皮拉',
        'symbol' => 'HNL',
        'symbol-alt-narrow' => 'L',
      ],
      'HRD' => [
      ...
      'KZT' => [
        'displayName' => '哈萨克斯坦腾格',
        'displayName-count-other' => '哈萨克斯坦腾格',
        'symbol' => 'KZT',
        'symbol-alt-narrow' => '₸',
      ],
      'LAK' => [
      ...
      'UAH' => [
        'displayName' => '乌克兰赫夫纳',
        'displayName-count-other' => '乌克兰赫夫纳',
        'symbol' => 'UAH',
        'symbol-alt-narrow' => '₴',
      ],
      'UAK' => [
      ...
      'XAF' => [
        'displayName' => '中非金融合作法郎',
        'displayName-count-other' => '中非金融合作法郎',
        'symbol' => 'FCFA',
      ],
      'XAG' => [
        'displayName' => '白银',
      ...
      'XOF' => [
        'displayName' => '非洲金融共同体法郎',
        'displayName-count-other' => '非洲金融共同体法郎',
        'symbol' => 'CFA',
      ],
      'XPD' => [
        'displayName' => '钯',
